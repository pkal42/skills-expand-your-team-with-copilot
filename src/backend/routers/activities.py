...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced', 'no-difficulty' for activities without difficulty)
    """
    ...
    if difficulty:
        if difficulty == "no-difficulty":
            ...
            # Filter for activities with specific difficulty level
